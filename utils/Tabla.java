...
public class Tabla {
	...
	public void boldHeader(String font, boolean bold, int size) {
		tabla.getTableHeader().setFont(new Font(font, bold==true? Font.BOLD:Font.ITALIC, size));
	}
	public void esconderColumna(int columna) {
		TableColumn column = tabla.getColumnModel().getColumn(columna);
		column.setMinWidth(0);
		column.setMaxWidth(0);
		column.setPreferredWidth(0);
	}
	public void showColumnn(int columna, int medida) {
		TableColumn column = tabla.getColumnModel().getColumn(columna);
		column.setMinWidth(15);
		column.setMaxWidth(medida);
	    column.setWidth(medida);
	    column.setPreferredWidth(medida);
	}
